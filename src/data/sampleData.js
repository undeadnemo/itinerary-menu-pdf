const sampleData = {
  ...
  "menuDetail": [
    ...
    {
      "dishes": [
        { "name": "酸奶水果巴菲", "desc": "Yogurt Parfait" },
    ...
    {
      "dishes": [
        { "name": "蛋白欧姆蛋", "desc": "Egg White Omelet" },
        { "name": "太阳蛋", "desc": "Sunny Side-Up" },
        { "name": "水煮蛋", "desc": "Boiled Eggs" },
        { "name": "炒蘑菇", "desc": "Sauteed Mushrooms" },
        { "name": "香烤番茄", "desc": "Grilled Tomato" },
    ...
    {
      "dishes": [
        { "name": "鲜榨橙汁", "desc": "Fresh Orange Juice" },
        { "name": "早餐奶昔", "desc": "Breakfast Smoothie" },
        { "name": "精选咖啡&茶", "desc": "Premium Selection of Tea & Coffee" }
      ],
      "category": { "sub": "早餐饮品", "main": "早餐" }
    },
    {
      "dishes": [
        { "name": "鸡胸肉凯撒沙拉", "desc": "Chicken Caesar Salad" },
    ...
    },
    {
      "dishes": [
        ...
        { "name": "烤箱烘烤土豆", "desc": "Oven Roasted Potatoes" },
    ...
    {
      "dishes": [
        { "name": "时令果盘", "desc": "Seasonal Fresh Fruit Platter" },
